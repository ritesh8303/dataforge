...
def test_is_in_eu_with_indeed_dict():
    ...
    item_in_eu = {"location": {"cityName": "Bakersfield", "countryCode": "DE", "countryName": "Germany"}}
    assert is_in_eu(location_str="Bakersfield", item=item_in_eu) is True

    item_outside_eu = {"location": {"cityName": "Bakersfield", "countryCode": "US", "countryName": "United States"}}
