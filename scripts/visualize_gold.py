...
df_loc = pd.read_csv(GOLD_DIR / "top_locations.csv")
df_source = pd.read_csv(GOLD_DIR / "jobs_by_source.csv")
df_remote = pd.read_csv(GOLD_DIR / "remote_vs_onsite.csv")
df_trend = pd.read_csv(GOLD_DIR / "jobs_trend.csv")
df_companies = pd.read_csv(GOLD_DIR / "top_companies.csv")

fig = plt.figure(figsize=(18, 14))
fig.suptitle("European Data Job Market Dashboard", fontsize=18, fontweight="bold", y=0.98)
...
ax2.pie(
    df_source["job_count"], labels=df_source["source"], autopct="%1.1f%%", startangle=90
)
...
output = GOLD_DIR / "job_market_dashboard.png"
